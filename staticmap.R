...
#enter path to the joe_jobmap workingdir end string with /
workingdir<-""

#Read in data
joejobs <- read_excel(paste0(workingdir, "joe_resultset.xls"))
...
fipsandnames <- read_excel(paste0(workingdir, "fipsandnames.xlsx"))
...
#save plot
ggsave(filename=paste0(workingdir, "/joemap.png"))
